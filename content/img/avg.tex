...
\begin{tikzpicture}
\begin{resultAxis}
\addplot+[ybar] table [x=name, y expr=\thisrow{ldf_time} / 1000, col sep=semicolon]{content/img/avg.csv};
\addplot+[ybar] table [x=name, y expr=\thisrow{sort_time} / 1000, col sep=semicolon]{content/img/avg.csv};
\addplot+[ybar] table [x=name, y expr=\thisrow{comunica_time} / 1000, col sep=semicolon]{content/img/avg.csv};
