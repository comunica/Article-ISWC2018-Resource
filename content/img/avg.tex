...
\begin{tikzpicture}
\begin{resultAxis}
\addplot+[ybar] table [x=name, y=ldf_time, col sep=semicolon]{content/img/avg.csv};
\addplot+[ybar] table [x=name, y=comunica_time, col sep=semicolon]{content/img/avg.csv};
\legend{LDF,Comunica}
\end{resultAxis}
\end{tikzpicture}
\end{document}
