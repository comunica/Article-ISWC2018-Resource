...
\begin{tikzpicture}[
    ...
    \draw [fill=black!1!white] (1.8,1.6) rectangle (13.4,2.4);
    \draw[action,->,thick]     (2,2) -- (4,2) node[right] {Action};
    \draw[test,->,thick]       (6,2) -- (8,2) node[right] {Test};
    \draw[txt,<-,thick,dashed] (10,2) -- (12,2) node[right] {Reply};
