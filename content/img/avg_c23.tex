...
\begin{tikzpicture}
\begin{resultAxis}
\addplot+[xbar] table [y=name, x=ldf_time, col sep=semicolon]{content/img//avg_c23.csv};
\addplot+[xbar] table [y=name, x=comunica_time, col sep=semicolon]{content/img//avg_c23.csv};
\legend{}
\end{resultAxis}
\end{tikzpicture}
\end{document}
